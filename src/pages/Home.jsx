    ...
    <div>
      ...
      <div className="relative h-[calc(100vh-5.5rem)]">
        ...
        <div className="absolute z-10 container mx-auto px-6 flex flex-col h-full justify-center items-center">
          <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100' : 'opacity-0'} transform ${isVisible ? 'translate-y-0' : 'translate-y-10'}`}>
            <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">Voluntariado UNMSM</h1>
            ...
            <div className="flex flex-col md:flex-row items-center gap-12">
              ...
              <div className="md:w-2/3">
                ...
                <p className="text-gray-700 text-lg mb-6">
                  Somos una organización liderada por estudiantes voluntarios de la Universidad Nacional Mayor de San Marcos, 
                  comprometidos con la excelencia y el desarrollo social a través de la gestión de proyectos.
                </p>
                <p className="text-gray-700 text-lg mb-6">
                  Promovemos y aplicamos las buenas prácticas de dirección de proyectos con el objetivo de contribuir 
                  al desarrollo de nuestra universidad y sociedad, mediante la ejecución de iniciativas de alto impacto.
                </p>
                <button className="btn btn-outline btn-primary">Conoce Nuestra Historia</button>
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-neutral-50 rounded-lg p-8 shadow-md">
                ...
                <p className="text-gray-700 text-center">
                  Implementamos metodologías efectivas para la planificación y ejecución de proyectos 
                  que generan impacto real en nuestra comunidad universitaria y sociedad.
                </p>
              </div>
              ...
              <div className="bg-neutral-50 rounded-lg p-8 shadow-md">
                ...
                <p className="text-gray-700 text-center">
                  Ofrecemos talleres y programas formativos para estudiantes interesados en adquirir 
                  habilidades de liderazgo, trabajo en equipo y gestión de recursos.
                </p>
              </div>
              ...
              <div className="bg-neutral-50 rounded-lg p-8 shadow-md">
                ...
                <p className="text-gray-700 text-center">
                  Desarrollamos iniciativas que abordan problemas sociales y contribuyen 
              ...
              <div className="bg-neutral-50 p-6 rounded-lg shadow-md">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Estudiante de Administración</p>
                  </div>
                </div>
                <p className="text-gray-700 italic">
              ...
              <div className="md:w-1/2">
                <form className="space-y-4">
                  <div>
                    ...
                    <input type="text" id="name" className="w-full p-3 border rounded-md" placeholder="Tu nombre" />
                  </div>
                  <div>
                    <label htmlFor="email" className="block mb-2 text-gray-700">Email</label>
                    <input type="email" id="email" className="w-full p-3 border rounded-md" placeholder="tucorreo@ejemplo.com" />
                  </div>
                  <div>
                    <label htmlFor="message" className="block mb-2 text-gray-700">Mensaje</label>
                    <textarea id="message" rows="5" className="w-full p-3 border rounded-md" placeholder="¿Cómo podemos ayudarte?"></textarea>
                  </div>
                  <button type="submit" className="btn btn-primary px-8 py-3">Enviar Mensaje</button>
                </form>
              </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700">Ciudad Universitaria, UNMSM, Lima, Perú</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700">voluntariado@unmsm.edu.pe</p>
                      </div>
                    </div>
