            ...
            <div className="mb-16" data-aos="fade-up">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                  ...
                  { platform: "LinkedIn", followers: 4400, suffix: "k", divisor: 1000, color: "#0A66C2", icon: <Linkedin size={28} />, link: "https://www.linkedin.com/company/proyectossanmarcos" },
                  { platform: "Instagram", followers: 2200, suffix: "k", divisor: 1000, color: "#E1306C", icon: <Instagram size={28} />, link: "https://www.instagram.com/proyectossanmarcos" },
